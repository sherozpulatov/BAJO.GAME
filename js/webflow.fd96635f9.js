...
(() => {
  ...
  var le = (e, t, r) => (
    ...
    Ye = (e) => ga(Cr({}, "__esModule", { value: !0 }), e);
  var zn = d(() => {
    "use strict";
    window.tram = (function (e) {
      ...
      function i(l, y, A) {
        return (
          "#" + ((1 << 24) | (l << 16) | (y << 8) | A).toString(16).slice(1)
        );
      }
      function o() {}
      function a(l, y) {
      ...
      function u(l, y, A) {
        if ((y !== void 0 && (A = y), l === void 0)) return A;
        var O = A;
        return (
          Xe.test(l) || !Ce.test(l)
            ? (O = parseInt(l, 10))
            : Ce.test(l) && (O = 1e3 * parseFloat(l)),
          0 > O && (O = 0),
          O === O ? O : A
        );
      }
      ...
      var f = (function (l, y, A) {
          ...
          function Q(oe, ge) {
            function V() {
              var xe = new ae();
              return w(xe.init) && xe.init.apply(xe, arguments), xe;
            }
            function ae() {}
            ge === A && ((ge = oe), (oe = Object)), (V.Bare = ae);
            var ue,
              _e = (R[l] = oe[l]),
              je = (ae[l] = V[l] = new R());
            return (
              ...
              (V.open = function (xe) {
                if (
                  ...
                  for (var Zt in ue) y.call(ue, Zt) && (je[Zt] = ue[Zt]);
                return w(je.init) || (je.init = oe), V;
              }),
              V.open(ge)
            );
          }
        ...
        g = {
          ease: [
            ...
            function (l, y, A, O) {
              ...
              return (
                y +
                A * (-2.75 * R * w + 11 * w * w + -15.5 * R + 8 * w + 0.25 * l)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (l, y, A, O) {
              ...
              return (
                y +
                A * (0.3 * R * w + -1.6 * w * w + 2.2 * R + -1.8 * w + 1.9 * l)
              );
            },
          ],
          "ease-in-out": [
          ...
          "ease-in-out-expo": [
            ...
            function (l, y, A, O) {
              return l === 0
                ...
                ? y + A
                : (l /= O / 2) < 1
                ? (A / 2) * Math.pow(2, 10 * (l - 1)) + y
                : (A / 2) * (-Math.pow(2, -10 * --l) + 2) + y;
            },
          ],
          "ease-in-circ": [
          ...
          "ease-in-out-circ": [
            ...
            function (l, y, A, O) {
              return (l /= O / 2) < 1
                ? (-A / 2) * (Math.sqrt(1 - l * l) - 1) + y
                : (A / 2) * (Math.sqrt(1 - (l -= 2) * l) + 1) + y;
            },
          ],
          "ease-in-back": [
        ...
        U = function (l) {
          ...
          for (y = 0; y < x.length; y++)
            if (((A = x[y] + O), A in F.style))
              return { dom: A, css: D[y] + l };
        },
        q = (t.support = {
      ...
      var M = (t.frame = (function () {
        ...
        j = f(function (l) {
          function y(te, ce) {
            ...
            if (!ce.weak || !this.props[de]) {
              var Ve = Se[0],
                Le = this.props[de];
              return (
                Le || (Le = this.props[de] = new Ve.Bare()),
            ...
            if (te) {
              ...
              if (de == "object") {
                ...
                je.call(
                  ...
                  te,
                  function (Ie, Wv) {
                    Ie.span > Se && (Se = Ie.span), Ie.stop(), Ie.animate(Wv);
                  },
                  function (Ie) {
          ...
          function oe(te) {
            Q.call(this, te), je.call(this, te, Zt, Bv);
          }
          function ge(te) {
          ...
          function ue() {
            Q.call(this), e.removeData(this.el, T), (this.$el = this.el = null);
          }
          function _e() {
            var te,
              ce,
            ...
            (me = me.join(",")),
              this.style !== me &&
                ((this.style = me), (this.el.style[q.transition.dom] = me));
          }
              ...
              (Ve = te[de]),
                de in fe
                  ? (Ie.transform || (Ie.transform = {}),
                    (Ie.transform[de] = Ve))
                  : (C.test(de) && (de = r(de)),
                    de in B ? (Ie[de] = Ve) : (Le || (Le = {}), (Le[de] = Ve)));
            for (de in Ie) {
              if (((Ve = Ie[de]), (Se = this.props[de]), !Se)) {
                if (!Rr) continue;
                Se = y.call(this, de);
              }
              ce.call(this, Se, Ve);
          ...
          (l.init = function (te) {
            ...
            q.backface &&
              se.hideBackface &&
              E(this.el, q.backface.css, "hidden");
          }),
            ke("add", y),
            ke("start", A),
            ke("wait", O),
        ...
        m = f(j, function (l) {
          function y(A, O) {
            ...
            return w.el || w.init(A), O ? w.start(O) : w;
          }
          l.init = function (A, O) {
            var w = e(A);
            if (!w.length) return this;
            if (w.length === 1) return y(w[0], O);
            var R = [];
            return (
              w.each(function (Q, oe) {
                R.push(y(oe, O));
              }),
              (this.children = R),
              this
        ...
        b = f(function (l) {
          ...
          function A(R, Q, oe) {
            return Q !== void 0 && (oe = Q), R in g ? R : oe;
          }
          function O(R) {
            var Q = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(R);
            return (Q ? i(Q[1], Q[2], Q[3]) : R).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
        ...
        ne = f(b, function (l, y) {
          ...
          (l.init = function () {
            ...
            (l.transition = function (O) {
              ...
              var R,
                Q = {};
              for (R in this.current) Q[R] = R in w ? w[R] : this.current[R];
            ...
            (l.values = function (O) {
              var w,
                R = {};
              return (
                A.call(this, O, function (Q, oe, ge) {
                  (R[Q] = oe),
        ...
        Y = f(function (l) {
          ...
          var Q = { ease: g.ease[1], from: 0, to: 1 };
          (l.init = function (V) {
            ...
            (l.play = function () {
              this.active ||
                (this.start || (this.start = G()), (this.active = !0), y(this));
            }),
            (l.stop = function () {
            ...
            (l.render = function (V) {
              ...
              if (ue < this.duration) {
                ...
                return (
                  (ae = this.startRGB
                    ? R(this.startRGB, this.endRGB, _e)
            ...
            (l.format = function (V, ae) {
              ...
              if (!this.unit) {
                var ue = ae.replace(I, ""),
                  _e = V.replace(I, "");
                ue !== _e && s("tween", ae, V), (this.unit = ue);
              }
              (ae = parseFloat(ae)),
                (V = parseFloat(V)),
          ...
          (l.init = function (A) {
            ...
            (l.render = function (A) {
              ...
              for (O = R; O--; )
                (w = this.tweens[O]),
                  w.context &&
                    (w.render(A), (this.current[w.name] = w.value), (Q = !0));
              return Q
      ...
      (t.fallback = function (l) {
        if (!q.transition) return (se.fallback = !0);
        ...
        (t.delay = function (l, y, A) {
          return new J({ complete: y, duration: l, context: A });
        }),
      ...
      var E = e.style,
        X = e.css,
        K = { transform: q.transform && q.transform.css },
        B = {
          color: [k, P],
  ...
  var va = d((DF, ha) => {
    ...
    ha.exports = (function () {
      ...
      (e.map = e.collect =
        ...
        (e.find = e.detect =
          function (x, D, U) {
            ...
            return (
              H(x, function (Z, re, M) {
                if (D.call(U, Z, re, M)) return (q = Z), !0;
              }),
              q
            );
          }),
        ...
        e.any =
          function (x, D, U) {
            ...
            return x == null
              ...
              ? x.some(D, U)
              : (L(x, function (Z, re, M) {
                  if (q || (q = D.call(U, Z, re, M))) return t;
                }),
                !!q);
          });
      (e.contains = e.include =
        ...
        (e.debounce = function (x, D, U) {
          var q,
            ...
            j = function () {
              ...
              m < D
                ? (q = setTimeout(j, D - m))
                : ((q = null), U || ((G = x.apply(re, Z)), (re = Z = null)));
            };
          return function () {
        ...
        (e.defaults = function (x) {
          ...
          for (var D = 1, U = arguments.length; D < U; D++) {
            var q = arguments[D];
            for (var Z in q) x[Z] === void 0 && (x[Z] = q[Z]);
          }
          return x;
        }),
        (e.keys = function (x) {
          ...
          if (P) return P(x);
          var D = [];
          for (var U in x) e.has(x, U) && D.push(U);
          return D;
        }),
        (e.has = function (x, D) {
          return c.call(x, D);
      ...
      var W = /(.)^/,
        ...
        F = /^\s*(\w|\$)+\s*$/;
      return (
        (e.template = function (x, D, U) {
          !D && U && (D = U), (D = e.defaults({}, D, e.templateSettings));
          var q = RegExp(
              [
                (D.escape || W).source,
                (D.interpolate || W).source,
                (D.evaluate || W).source,
              ].join("|") + "|$",
              "g"
            ),
...
` +
  ...
  var qe = d((MF, wa) => {
    ...
    pe.ready = function () {
      (Pr = !0), Yn ? om() : Ue.each(wt, ma), Ue.each(jn, ma), pe.resize.up();
    };
    function ma(e) {
      Qe(e) && e();
    }
    ...
    $n.define(
      ...
      (Oa.exports = function (e, t, r) {
        ...
        function T(P) {
          return P.indexOf("//") >= 0
            ? P
            : I("https://editor-api.webflow.com" + P);
        }
        function I(P) {
        ...
        function e(r) {
          ...
          function u(S) {
            var P = S.type,
              N = S.tagName;
            return !!(
              (N === "INPUT" && a[P] && !S.readOnly) ||
              (N === "TEXTAREA" && !S.readOnly) ||
              S.isContentEditable
            );
          }
          function c(S) {
  ...
  var qa = d((kF, Fa) => {
    ...
    $e.triggers = {};
    $e.types = { INTRO: "w-ix-intro" + Ma, OUTRO: "w-ix-outro" + Ma };
    $e.init = function () {
      for (var e = Nr.length, t = 0; t < e; t++) {
        var r = Nr[t];
        r[0](0, r[1]);
      }
      (Nr = []), Zn.extend($e.triggers, Dr);
    };
    $e.async = function () {
      for (var e in Dr) {
        var t = Dr[e];
  ...
  var ei = d((VF, ka) => {
    ...
    var um = window.jQuery,
      ...
      cm = {
        ...
        intro: function (e, t) {
          Jn.triggers.intro(e, t), Ga(t, "COMPONENT_ACTIVE");
        },
        outro: function (e, t) {
          Jn.triggers.outro(e, t), Ga(t, "COMPONENT_INACTIVE");
        },
      };
    Mr.triggers = {};
    Mr.types = { INTRO: "w-ix-intro" + Xa, OUTRO: "w-ix-outro" + Xa };
  ...
  var ui = d((er) => {
    ...
    var ss = (er.ActionTypes = { INIT: "@@redux/INIT" });
    function cs(e, t, r) {
      var n;
      if (
  ...
  var Ot = d((Ee) => {
    ...
    function kr(e, t) {
      if ((!Array.isArray(t) && ws(Ts), e != null)) {
    ...
    function qs(e, t, r, n, i, o, a) {
      ...
      return (
        v.length
          ? (u = Me.call.apply(Me, [null, !1, !1, s, r, n, i, o, a].concat(v)))
  ...
  var fc = d((p1, lc) => {
    ...
    function zr(e) {
      var t = -1,
        r = e == null ? 0 : e.length;
      for (this.__data__ = new Ib(); ++t < r; ) this.add(e[t]);
    }
  ...
  var Ai = d((v1, vc) => {
    ...
    function Lb(e, t, r, n, i, o) {
      ...
      for (o.set(e, t), o.set(t, e); ++f < s; ) {
        var h = e[f],
          _ = t[f];
        if (n) var T = a ? n(_, h, f, t, e, o) : n(h, _, f, e, t, o);
        if (T !== void 0) {
          if (T) continue;
          g = !1;
          break;
        ...
        if (p) {
          if (
            !Sb(t, function (I, C) {
              if (!Ob(p, C) && (h === I || i(h, I, r, n, o))) return p.push(C);
            })
          ) {
            g = !1;
            break;
  ...
  var Jr = d((X1, cl) => {
    ...
    function Cw(e) {
      if (!xw(e)) return Sw(e);
      var t = [];
      for (var r in Object(e)) Rw.call(e, r) && r != "constructor" && t.push(r);
      return t;
    }
    cl.exports = Cw;
  });
  ...
  var vl = d((B1, hl) => {
    ...
    function Ww(e, t, r, n, i, o) {
      ...
      for (var f = u; f--; ) {
        var g = s[f];
        if (!(a ? g in t : Hw.call(t, g))) return !1;
      }
      var p = o.get(e),
        h = o.get(t);
      ...
      for (var T = a; ++f < u; ) {
        ...
        var I = e[g],
          C = t[g];
        if (n) var S = a ? n(C, I, g, t, e, o) : n(I, C, g, e, t, o);
  ...
  var Gl = d((Y1, ql) => {
    ...
    function v0(e, t, r, n, i, o) {
      ...
      return g ? (o || (o = new Gi()), d0(e, t, r, n, i, o)) : !1;
    }
    ql.exports = v0;
  });
  var Xi = d((Q1, Vl) => {
    ...
    function b0(e, t, r, n) {
      ...
      for (; ++i < o; ) {
        ...
        if (a && s[2]) {
          ...
          if (!(g === void 0 ? y0(v, c, _0 | I0, n, f) : g)) return !1;
        }
      }
      return !0;
    }
  ...
  var rn = d((nq, $l) => {
    ...
    function V0(e, t) {
      ...
      return r == "number" ||
        ...
        G0(e)
        ? !0
        : k0.test(e) || !X0.test(e) || (t != null && e in Object(t));
    }
    $l.exports = V0;
  });
  var ef = d((iq, Jl) => {
    ...
    function Ui(e, t) {
      ...
      return (r.cache = new (Ui.Cache || Zl)()), r;
    }
    Ui.Cache = Zl;
    Jl.exports = Ui;
  });
  ...
  var nn = d((dq, mf) => {
    ...
    function pA(e, t) {
      t = fA(t, e);
      for (var r = 0, n = t.length; e != null && r < n; ) e = e[dA(t[r++])];
  ...
  var jf = d((Cq, Kf) => {
    ...
    function wx(e, t, r) {
      ...
      if (!n) return -1;
      var i = r == null ? 0 : bx(r);
      return i < 0 && (i = Tx(n + i, 0)), _x(e, Ix(t, 3), i);
    }
    Kf.exports = wx;
  });
  var ji = d((Lq, Yf) => {
  ...
  var Qi = d((Pq, nd) => {
    ...
    function Dx(e, t, r, n, i) {
      var o,
        ...
        s = 0;
      do
        (a = t + (r - t) / 2), (o = dn(a, n, i) - e), o > 0 ? (r = a) : (t = a);
    ...
    nd.exports = function (t, r, n, i) {
      ...
      if (t !== r || n !== i)
        for (var a = 0; a < dr; ++a) o[a] = dn(a * fn, t, n);
      function s(u) {
        for (var c = 0, v = 1, f = dr - 1; v !== f && o[v] <= u; ++v) c += fn;
        --v;
  ...
  var pr,
    ...
    $i = ve(() => {
      ...
      (pr = le(Qi())),
        (it = 1.70158),
        (Fx = (0, pr.default)(0.25, 0.1, 0.25, 1)),
        (qx = (0, pr.default)(0.42, 0, 1, 1)),
        (Gx = (0, pr.default)(0, 0, 0.58, 1)),
        (Xx = (0, pr.default)(0.42, 0, 0.58, 1));
    });
  var od = {};
  Pe(od, {
    applyEasing: () => _S,
  ...
  function _S(e, t, r) {
    return t === 0
      ...
      : t === 1
      ? 1
      : hr(r ? (t > 0 ? r(t) : t) : t > 0 && e && gr[e] ? gr[e](t) : t);
  }
  var id,
    Zi = ve(() => {
      "use strict";
  ...
  function sd(e, t, r, n, i) {
    let o =
      r === IS ? (0, qt.getIn)(i, ["config", "target", "objectId"]) : null;
    return (0, qt.mergeIn)(e, [n], { id: n, ref: t, refId: o, refType: r });
  }
  function Ji(e, t, r, n, i) {
    let o = FS(i);
    return (0, qt.mergeIn)(e, [t, NS, r], n, o);
  }
  function FS(e) {
    let { config: t } = e;
          ...
          switch (t.type) {
            ...
            case LS: {
              let {
                ...
                u = e;
              return (
                (0, qt.getIn)(u, [r, n]) !== n && (u = sd(u, n, a, r, o)),
                Ji(u, r, s, i, o)
              );
            }
            case PS: {
    ...
    var zS = (e) => document.querySelector(`[data-w-id="${e}"]`),
      ...
      $S = (e, t) => {
        ...
        if (e) {
          let o = Object.keys(e),
            a = jS(n, o);
          return a.length ? a.reduce((u, c) => ((u[c] = fd[c]), u), e) : e;
        }
      ...
      lO = (e, { PLUGIN_RIVE: t }, r) => {
        ...
        function u(c) {
          ...
          function v() {
            ...
            if (f != null) {
              if ((c.isPlaying || c.play(a, !1), ro in s || no in s)) {
                let g = c.layout,
                  p = s[ro] ?? g.fit,
                  h = s[no] ?? g.alignment;
                (p !== g.fit || h !== g.alignment) &&
                  (c.layout = g.copyWith({ fit: p, alignment: h }));
              }
              for (let g in s) {
                if (g === ro || g === no) continue;
  ...
  var ao = d((oo) => {
    ...
    function dO(e) {
      let t,
        ...
        s = (typeof gd[o] == "string" ? gd[o].toLowerCase() : null) || o;
      if (s.startsWith("#")) {
        let u = s.substring(1);
    ...
    var gO = ao(),
      ...
      _O = (e, t, r) => {
        let n = r.config.target.objectId,
          ...
          { PLUGIN_VARIABLE: o } = t,
          { size: a, red: s, green: u, blue: c, alpha: v } = o,
          f;
        a != null && (f = a + i),
          s != null &&
            c != null &&
  ...
  var md = d((uo) => {
    ...
    var xO = new Map([
      [pn.ActionTypeConsts.PLUGIN_LOTTIE, { ...bO }],
      [pn.ActionTypeConsts.PLUGIN_SPLINE, { ...TO }],
      [pn.ActionTypeConsts.PLUGIN_RIVE, { ...wO }],
      [pn.ActionTypeConsts.PLUGIN_VARIABLE, { ...AO }],
    ]);
  });
  var Ed = {};
  Pe(Ed, {
  ...
  function wo({
    ...
    if (T) return [hn.has(T) ? hn.get(T) : hn.set(T, {}).get(T)];
    if (S === mi.PAGE) {
      let F = a(_);
      return F ? [F] : [];
    }
    ...
    if (
      (H
        ? ((W = L.limitAffectedElements), (z = ie), ($ = s(L)))
        : (z = $ = s({ id: _, selector: I, selectorGuids: C })),
      t && P)
    ) {
      let F = r && ($ || P === !0) ? [r] : u(ie);
      if ($) {
        if (P === ER) return u($).filter((x) => F.some((D) => g(x, D)));
        if (P === Vd) return u($).filter((x) => F.some((D) => g(D, x)));
        if (P === Ud) return u($).filter((x) => F.some((D) => p(D, x)));
      }
      return F;
    }
    return z == null || $ == null
  ...
  function PR(e, t = {}, r = {}, n, i) {
    ...
    switch (n.actionTypeId) {
      ...
      case $d:
        return { value: (0, ot.default)(parseFloat(o(e, mn)), 1) };
      case Ut: {
        let s = o(e, et),
          u = o(e, tt),
          c,
        ...
        return (
          n.config.widthUnit === pt
            ? (c = Hd.test(s) ? parseFloat(s) : parseFloat(r.width))
            : (c = (0, ot.default)(parseFloat(s), parseFloat(r.width))),
          n.config.heightUnit === pt
            ? (v = Hd.test(u) ? parseFloat(u) : parseFloat(r.height))
            : (v = (0, ot.default)(parseFloat(u), parseFloat(r.height))),
  ...
  function FR({ element: e, actionItem: t, elementApi: r }) {
    ...
    switch (t.actionTypeId) {
      ...
      case Ut: {
        ...
        if (s === pt) {
          let v = n(e, tt);
          i(e, tt, ""), (c = o(e, "offsetHeight")), i(e, tt, v);
        }
  ...
  function BR(e, t, r, n, i) {
    let o = UR.map((s) => {
      ...
      { setStyle: a } = i;
    _t(e, dt, i), a(e, dt, o), zR(n, r) && a(e, cn, pR);
  }
  function HR(e, t, r, n) {
    let i = (0, yn.default)(t, (a, s, u) => `${a} ${u}(${s}${VR(u, r)})`, ""),
      { setStyle: o } = n;
    _t(e, vr, n), o(e, vr, i);
  }
  function WR(e, t, r, n) {
  ...
  function ZR(e, t, r, n, i, o) {
    ...
    switch (n.actionTypeId) {
      case Ut: {
        ...
        c !== void 0 && (s === pt && (s = "px"), _t(e, et, o), a(e, et, c + s)),
          v !== void 0 &&
            (u === pt && (u = "px"), _t(e, tt, o), a(e, tt, v + u));
        break;
      }
      case _r: {
        HR(e, r, n.config, o);
  ...
  function eC({ store: e, elementApi: t }) {
    ...
    Object.keys(n).forEach((o) => {
      let a = n[o],
        ...
        { actionListId: u } = s,
        c = i[u];
      c && Wd({ actionList: c, event: a, elementApi: t });
    }),
    ...
    n &&
      ...
      i &&
        i.forEach((o) => {
          ...
          a.forEach((s) => {
            zd({ actionGroup: s, event: t, elementApi: r });
          });
        });
  }
  function zd({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((i) => {
      ...
      Et(o)
        ? (s = (u) => ho(o)(u, i))
        : (s = rp({ effect: rC, actionTypeId: o, elementApi: r })),
        wo({ config: a, event: t, elementApi: r }).forEach(s);
    });
  }
  function tC(e, t, r) {
  ...
  function iC({ actionList: e, actionItemId: t, rawData: r }) {
    let { actionItemGroups: n, continuousParameterGroups: i } = e,
      o = [],
      a = (s) => (
        o.push((0, _n.mergeIn)(s, ["config"], { delay: 0, duration: 0 })),
        s.id === t
      );
    return (
  ...
  var ot,
    ...
    op = ve(() => {
      "use strict";
      (ot = le(_d())), (yn = le(Dd())), (vn = le(Gd())), (_n = le(Ot()));
      De();
      kd();
      Zi();
      Kd = le(ao());
      ...
      ({
        ...
        (Zd = (e) => e.trim()),
        (To = Object.freeze({ [Bt]: jd, [Ht]: hR, [Wt]: vR })),
        (Jd = Object.freeze({
          [dt]: aR,
          [jd]: oR,
          [mn]: mn,
    ...
    cp = ve(() => {
      ...
      (Tn = le(It())),
        ...
        (SC = (e, t) => {
          ...
          return (0, at.merge)(e, { position: I, current: H });
        }),
        (OC = (e, t) => {
          let {
              active: r,
          ...
          if (r && n) {
            ...
            if (s) {
              ...
              e = (0, at.set)(e, "verboseTimeElapsed", z * $);
            }
            if (S < 0) return e;
          ...
          switch (t.type) {
            ...
            case yC: {
              ...
              return (0, at.set)(e, r, {
                ...
                skipToValue: W,
                customEasingFn:
                  Array.isArray(x) && x.length === 4 ? TC(x) : void 0,
              });
            }
            case _C: {
  ...
  var Dp = d((bG, Np) => {
    ...
    function yL(e) {
      if (e == null) return 0;
      if (gL(e)) return hL(e) ? vL(e) : e.length;
      var t = pL(e);
  ...
  var Vp = d((xG, kp) => {
    ...
    function RL(e, t, r) {
      var n = e[t];
      (!(OL.call(e, t) && xL(n, r)) || (r === void 0 && !(t in e))) &&
        AL(e, t, r);
    }
    kp.exports = RL;
  });
  ...
  var ug = d((FG, sg) => {
    ...
    function SP(e) {
      ...
      if (
        ...
        return !e.length;
      var t = vP(e);
      if (t == TP || t == wP) return !e.size;
      if (IP(e)) return !hP(e).length;
  ...
  var Ig = d((UG, _g) => {
    ...
    function zP(e, t, r) {
      ...
      function p(L) {
        var H = n,
          W = i;
        return (n = i = void 0), (c = L), (a = e.apply(W, H)), a;
      }
      function h(L) {
        return (c = L), (s = setTimeout(I, t)), v ? p(L) : a;
      }
      function _(L) {
        var H = L - u,
          W = L - c,
      ...
      function N() {
        ...
        if (((n = arguments), (i = this), (u = L), H)) {
          ...
          if (f) return clearTimeout(s), (s = setTimeout(I, t)), p(u);
        }
        return s === void 0 && (s = setTimeout(I, t)), a;
      }
      return (N.cancel = S), (N.flush = P), N;
    }
    _g.exports = zP;
  });
  var Tg = d((BG, bg) => {
    ...
    function QP(e, t, r) {
      var n = !0,
        i = !0;
      if (typeof e != "function") throw new TypeError(YP);
      return (
        jP(r) &&
  ...
  var wg,
    ...
    Sn = ve(() => {
      ...
      (wg = le(It())),
        ({
          IX2_RAW_DATA_IMPORTED: $P,
          IX2_SESSION_INITIALIZED: ZP,
          IX2_SESSION_STARTED: JP,
          IX2_SESSION_STOPPED: eN,
          IX2_PREVIEW_REQUESTED: tN,
          IX2_PLAYBACK_REQUESTED: rN,
          IX2_STOP_REQUESTED: nN,
          IX2_CLEAR_REQUESTED: iN,
          IX2_EVENT_LISTENER_ADDED: oN,
          IX2_TEST_FRAME_RENDERED: aN,
          IX2_EVENT_STATE_CHANGED: sN,
          IX2_ANIMATION_FRAME_CHANGED: uN,
          IX2_PARAMETER_CHANGED: cN,
          IX2_INSTANCE_ADDED: lN,
          IX2_INSTANCE_STARTED: fN,
          IX2_INSTANCE_REMOVED: dN,
          IX2_ELEMENT_STATE_CHANGED: pN,
          IX2_ACTION_LIST_PLAYBACK_CHANGED: gN,
          IX2_VIEWPORT_WIDTH_CHANGED: hN,
          IX2_MEDIA_QUERIES_DEFINED: vN,
        } = be),
        ({ reifyState: mN } = wg.IX2VanillaUtils),
        (No = (e) => ({ type: $P, payload: { ...mN(e) } })),
        ...
        (_N = (e) => ({ type: nN, payload: { actionListId: e } })),
        (IN = () => ({ type: iN })),
        (wn = (e, t) => ({
          type: oN,
          payload: { target: e, listenerParams: t },
        })),
        (bN = (e = 1) => ({ type: aN, payload: { step: e } })),
        (qo = (e, t) => ({ type: sN, payload: { stateKey: e, newState: t } })),
        (An = (e, t) => ({ type: uN, payload: { now: e, parameters: t } })),
        (Kt = (e, t) => ({ type: cN, payload: { key: e, value: t } })),
        (Go = (e) => ({ type: lN, payload: { ...e } })),
        (xn = (e, t) => ({ type: fN, payload: { instanceId: e, time: t } })),
        (Xo = (e) => ({ type: dN, payload: { instanceId: e } })),
        (ko = (e, t, r, n) => ({
          type: pN,
  ...
  function Ho({ id: e, selector: t }) {
    if (e) {
      ...
      if (e.indexOf(xg) !== -1) {
        let n = e.split(xg),
          i = n[0];
        if (((r = n[1]), i !== document.documentElement.getAttribute(Og)))
          return null;
      }
  ...
  var Kg = d((JG, zg) => {
    ...
    function jN(e, t, r) {
      return (
        (t = Wg(t === void 0 ? e.length - 1 : t, 0)),
        function () {
          for (
            var n = arguments, i = -1, o = Wg(n.length - t, 0), a = Array(o);
            ++i < o;
  ...
  var Yo = d((cX, hh) => {
    ...
    function mD(e) {
      for (
        var t = e.name + "", r = gh[t], n = vD.call(gh, t) ? r.length : 0;
        n--;
  ...
  var _h = d((dX, yh) => {
    ...
    function AD(e) {
      ...
      return (
        (t.__actions__ = wD(e.__actions__)),
  ...
  var Th = d((pX, bh) => {
    ...
    function Nn(e) {
      if (RD(e) && !OD(e) && !(e instanceof xD)) {
        ...
        if (PD.call(e, "__wrapped__")) return CD(e);
      }
      return new Ih(e);
    }
  ...
  var Ah = d((gX, wh) => {
    ...
    function qD(e) {
      var t = MD(e),
        r = FD[t];
      if (typeof r != "function" || !(t in ND.prototype)) return !1;
      if (e === r) return !0;
      var n = DD(r);
      return !!n && e === n[0];
    }
    ...
    function zD(e) {
      return GD(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          ...
          if (i && !a && Qo(o) == "wrapper") var a = new xh([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          o = t[n];
          var s = Qo(o),
          ...
          u[9] == 1
            ...
            : (a = o.length == 1 && Sh(o) ? a[s]() : a.thru(o));
        }
        return function () {
          var c = arguments,
            v = c[0];
          if (a && c.length == 1 && kD(v)) return a.plant(v).value();
    ...
    iv = ve(() => {
      ...
      (Kh = le(It())),
        ({
          ...
          PAGE_SCROLL_DOWN: jh,
          SCROLL_INTO_VIEW: Yh,
          SCROLL_OUT_OF_VIEW: pM,
          PAGE_SCROLL_UP: gM,
          SCROLLING_IN_VIEW: hM,
          PAGE_FINISH: Qh,
          ECOMMERCE_CART_CLOSE: vM,
          ECOMMERCE_CART_OPEN: mM,
          PAGE_START: $h,
          PAGE_SCROLL: EM,
        } = We),
        (Zo = "COMPONENT_ACTIVE"),
          ...
          return (
            c &&
              Yt({
                ...
                actionListId: (0, Wh.default)(c, "action.config.actionListId"),
              }),
            Yt({
              store: e,
              eventId: a,
        ...
        (ea = { types: Jo }),
        (IM = { PAGE_START: $h, PAGE_FINISH: Qh }),
        (Tr = (() => {
        ...
        (Dn = (e = !0) => ({
          ...
          handler: Ke(
            e ? rt : wr,
            rv((t, r) => (r.isActive ? Ar.handler(t, r) : r))
          ),
        })),
        (Mn = (e = !0) => ({
          ...tv,
          handler: Ke(
            e ? rt : wr,
            rv((t, r) => (r.isActive ? r : Ar.handler(t, r)))
          ),
        })),
        (Uh = {
          ...ea,
        ...
        (nv = {
          ...
          [uM]: Dn(),
          [cM]: Mn(),
          [mM]: { types: "ecommerce-cart-open", handler: Ke(rt, Fe) },
          [vM]: { types: "ecommerce-cart-close", handler: Ke(rt, Fe) },
          [ZD]: {
            types: "click",
            handler: Ke(
              rt,
          ...
          [hM]: {
            ...
            handler: (
              ...
              if (v === Ze.VIEWPORT) {
                let P = S ? o / s : a / u;
                return (
                  P !== i.scrollPercent && t.dispatch(Kt(g, P)),
                  { scrollPercent: P }
                );
              } else {
                let P = qh(n, g),
                ...
                return (
                  x !== i.scrollPercent && t.dispatch(Kt(P, x)),
                  { scrollPercent: x }
                );
              }
            },
  ...
  function jM(e) {
    bt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: $M }),
      bt({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: ZM }),
      bt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: JM }),
      bt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: eF });
  }
  function YM(e) {
    bt({
      store: e,
  ...
  function $M({ rawData: e, defer: t }, r) {
    let n = () => {
      Vn({ store: r, rawData: e, allowEvents: !0 }), hv();
    };
    t ? setTimeout(n, 0) : n();
  }
  function hv() {
  ...
  function ZM(e, t) {
    ...
    if (n && i && v && s) {
      ...
      f && (v = qM({ actionList: f, actionItemId: i, rawData: v }));
    }
    if (
      (Vn({ store: t, rawData: v, allowEvents: a, testManual: u }),
      ...
      c && f && t.dispatch(jt({ actionListId: n, isPlaying: !s }));
    }
  }
  function JM({ actionListId: e }, t) {
    e ? Yt({ store: t, actionListId: e }) : Ev({ store: t }), Un(t);
  }
  function eF(e, t) {
    Un(t), gv({ store: t, elementApi: Re });
  }
  function Vn({ store: e, rawData: t, allowEvents: r, testManual: n }) {
    ...
    t && e.dispatch(No(t)),
      i.active ||
        ...
        r &&
          (aF(e), tF(), e.getState().ixSession.hasDefinedMediaQueries && YM(e)),
        e.dispatch(Mo()),
        rF(e, n));
  }
  function tF() {
  ...
  function rF(e, t) {
    let r = (n) => {
      ...
      i.active &&
        (e.dispatch(An(n, o)), t ? QM(e, r) : requestAnimationFrame(r));
    };
  ...
  function iF({
    ...
    I.forEach((P) => {
      ...
      T.forEach(({ element: P, key: N }) => {
        let L = _[N],
          H = (0, st.default)(L, "[0].actionItems[0]", {}),
          { actionTypeId: W } = H,
          z = kn(W) ? oa(W)(P, H) : null,
          $ = ia({ element: P, actionItem: H, elementApi: Re }, z);
        aa({
          store: e,
          element: P,
          eventId: n,
  ...
  function dF({ logic: e, store: t, events: r }) {
    ...
    (0, Qt.default)(s, (f, g) => {
      ...
      BM(T, o.mediaQueryKeys) || t.dispatch(Uo()),
        h.actionTypeId === Ne.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(p.config) ? p.config : [p.config]).forEach((S) => {
            let { continuousParameterGroupId: P } = S,
              N = (0, st.default)(a, `${I}.continuousParameterGroups`, []),
              L = (0, sv.default)(N, ({ id: z }) => z === P),
              H = (S.smoothing || 0) / 100,
        ...
        (h.actionTypeId === Ne.GENERAL_START_ACTION || ra(h.actionTypeId)) &&
          mv({ store: t, actionListId: I, eventId: _ });
    });
    let u = (f) => {
        ...
        lF(s, (p, h, _) => {
          ...
          if (!Xn(S, g.mediaQueryKey)) return;
          let P = (N = {}) => {
            let L = i(
              {
                store: t,
          ...
          C.actionTypeId === Ne.GENERAL_CONTINUOUS_ACTION
            ? (Array.isArray(T.config) ? T.config : [T.config]).forEach(P)
            : P();
        });
      },
      c = (0, dv.default)(u, KM),
      v = ({ target: f = document, types: g, throttle: p }) => {
        g.split(" ")
          ...
          .forEach((h) => {
            let _ = p ? c : u;
            f.addEventListener(h, _), t.dispatch(wn(f, [h, _]));
          });
      };
  ...
  function mv({ store: e, actionListId: t, eventId: r }) {
    ...
    if (u && u.useFirstGroupAsInitialState) {
      let c = (0, st.default)(u, "actionItemGroups[0].actionItems", []),
        v = (0, st.default)(s, "mediaQueries", n.mediaQueryKeys);
      if (!Xn(v, i.mediaQueryKey)) return;
      c.forEach((f) => {
        let { config: g, actionTypeId: p } = f,
          h =
            g?.target?.useEventTarget === !0 && g?.target?.objectId == null
              ...
              : g,
          _ = Gn({ config: h, event: s, elementApi: Re }),
          T = kn(p);
        _.forEach((I) => {
          let C = T ? oa(p)(I, f) : null;
          aa({
            destination: ia({ element: I, actionItem: f, elementApi: Re }, C),
            immediate: !0,
            store: e,
            element: I,
            eventId: r,
  ...
  function Ev({ store: e }) {
    ...
    (0, Qt.default)(t, (r) => {
      if (!r.continuous) {
        ...
        sa(r, e), i && e.dispatch(jt({ actionListId: n, isPlaying: !1 }));
      }
    });
  }
  function Yt({
  ...
  function xr({
    ...
    let { ixData: u, ixSession: c } = e.getState(),
      ...
      p = (0, st.default)(u, `actionLists.${i}`, {}),
      { actionItemGroups: h, useFirstGroupAsInitialState: _ } = p;
    if (!h || !h.length) return !1;
    o >= h.length && (0, st.default)(f, "config.loop") && (o = 0),
      o === 0 && _ && o++;
    let I =
        (o === 0 || (o === 1 && _)) && ra(f.action?.actionTypeId)
          ? f.config.delay
          : void 0,
      C = (0, st.default)(h, [o, "actionItems"], []);
    if (!C.length || !Xn(g, c.mediaQueryKey)) return !1;
    ...
    return (
      C.forEach((L, H) => {
        ...
        Gn({
          ...
          N = !0;
          let re = P === H && U === 0,
            M = MM({ element: D, actionItem: L }),
            G = ia({ element: D, actionItem: L, elementApi: Re }, q);
          aa({
            store: e,
            element: D,
            actionItem: L,
  ...
  function aa(e) {
    let { store: t, computedStyle: r, ...n } = e,
      ...
      { refState: I } = p[T] || {},
      C = zo(i),
      S = h.reducedMotion && yi[o.actionTypeId],
      P;
    if (S && u)
    ...
    bt({ store: t, select: ({ ixInstances: L }) => L[g], onChange: _v }),
  ...
  function sa(e, t) {
    ...
    let { elementId: r, actionItem: n } = e,
      ...
      { ref: o, refType: a } = i[r] || {};
    a === pv && kM(o, n, Re), t.dispatch(Xo(e.id));
  }
  function yv(e, t, r) {
  ...
  function gF(e, t) {
    ...
    e.dispatch(xn(t, 0)), e.dispatch(An(performance.now(), r));
    ...
    if (Xn(H, P.mediaQueryKey) && (n || r || i)) {
      ...
      if (i) {
        if (_) {
          ...
          I && !W && t.dispatch(jt({ actionListId: h, isPlaying: !1 }));
        }
        sa(e, t);
      }
    }
  ...
  var sv,
    ...
    ta = ve(() => {
      ...
      (cF = (e, t) => (0, cv.default)((0, fv.default)(e, t), lv.default)),
        (lF = (e, t) => {
          (0, Qt.default)(e, (r, n) => {
            r.forEach((i, o) => {
              let a = n + na + o;
  ...
  var wv = d((ca) => {
    ...
    var Bn = (0, vF.createStore)(mF.default);
    function IF(e) {
      e() && (0, ua.observeRequests)(Bn);
    }
    function bF(e) {
      Tv(), (0, ua.startEngine)({ store: Bn, rawData: e, allowEvents: !0 });
    }
    function Tv() {
      (0, ua.stopEngine)(Bn);
    }
      ...
      (Rv.exports = function (e, t) {
        ...
        function p() {
          (i = o && $t.env("design")),
            ...
            $t.scroll.off(_),
            (f = []);
          for (var I = document.links, C = 0; C < I.length; ++C) h(I[C]);
          f.length && ($t.scroll.on(_), _());
        }
        function h(I) {
          if (!I.getAttribute("hreflang")) {
            ...
            if (((s.href = C), !(C.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var P = e(s.hash);
                P.length && f.push({ link: S, sec: P, active: !1 });
                return;
              }
              if (!(C === "#" || C === "")) {
                var N =
                  s.href === a.href || C === g || (c.test(C) && v.test(g));
                T(S, u, N);
              }
            }
          }
        ...
        function S(F, x) {
          ...
          switch (x) {
            case "add":
              (D = F.attr("tabindex")),
                D
                  ? F.attr("data-wf-tabindex-swap", D)
                  : F.attr("tabindex", "-1");
              break;
            case "remove":
            ...
            if (a) {
              ...
              (v = C),
                Math.abs(S) > u &&
                  r &&
                  String(r()) === "" &&
                  (i("swipe", T, { direction: S > 0 ? "right" : "left" }), h());
            }
          }
          function p(T) {
    ...
    Wn.define(
      ...
      (Fv.exports = function (e, t) {
        ...
        function P() {
          ...
          n.on(
            ...
            n.on("change", s + ' form input[type="radio"]', (ne) => {
              e(`input[name="${ne.target.name}"]:not(${M})`).map((J, ye) =>
                e(ye).siblings(G).removeClass(j)
              );
              let Y = e(ne.target);
        ...
        function L(M) {
          var G = M.btn,
            j = M.wait;
          G.prop("disabled", !0), j && ((M.label = G.val()), G.val(j));
        }
        function H(M, G) {
          var j = null;
          return (
        ...
        function W(M) {
          var G = {};
          return (
            M.find(':input[type="file"]').each(function (j, m) {
              var b = e(m),
          ...
          return (
            G === "password"
              ...
              ? m
                ? c.test(M.attr("type")) &&
                  (v.test(m) ||
                    (b = "Please enter a valid email address for: " + j))
                : (b = "Please fill out the required field: " + j)
        ...
        function x(M) {
          ...
          (ne = k.substring(ne, k.indexOf("&", ne))),
            (j["b_" + ee + "_" + ne] = ""),
            e
              .ajax({ url: k, data: j, dataType: "jsonp" })
              .done(function (Y) {
        ...
        function q(M, G) {
          ...
          var j,
            ...
            X = ee.find(".w-file-remove-link"),
            K = E.find(".w-file-upload-file-name"),
            B = se.attr("data-w-size-error"),
          ...
          function y(w, R) {
            ...
            var Q = R.fileName,
              ...
              ge = R.fileId,
              V = R.s3Url;
            Y.attr("data-value", ge), re(V, oe, j, Q, A);
          }
          function A(w) {
            if (w) return l(w);
            k.toggle(!1),
  ...
  var kv = d((DX, Xv) => {
    ...
    function da(e, t) {
      for (var r = e; r >= 0; r--) if (!Or(t[r])) return r;
      return -1;
    }
    function pa(e, t) {
      for (var r = e; r <= t.length - 1; r++) if (!Or(t[r])) return r;
      return -1;
    }
    function SF(e, t) {
      return da(e - 1, t) === -1;
    ...
    function RF(e, t, r, n) {
      ...
      (h.build = function () {
        ...
        (h.show = function (m) {
          if (m !== v) {
            ...
            return (
              $(Y, function (J) {
                if (m !== v) return;
                var ye = G("figure", "figure").append(q(J, "image")),
                  se = G("frame").append(ye),
                  E = G("view")
                    .prop("tabIndex", 0)
                ...
                b.html &&
                  ...
                  ye.append(q(X, "embed"))),
                  b.caption &&
                    ye.append(G("caption", "figcaption").text(b.caption)),
                  f.spinner.before(E),
                  K || B();
                function B() {
                  if (
                  ...
                  if (
                    ...
                    var Ce = f.items.eq(m);
                    q(Ce, "active"), Ce.attr("aria-selected", !0), F(Ce);
                  }
                }
              }),
        ...
        (h.hide = function () {
          return (
            i(f.lightbox).add("opacity .3s").start({ opacity: 0 }).then(z), h
          );
        }),
        (h.prev = function () {
          var m = da(v - 1, c);
      ...
      var T = _(h.prev),
        ...
        S = function (m) {
          var b = r(this).index();
          m.preventDefault(), h.show(b);
        },
        P = function (m, b) {
          m.preventDefault(),
            b.direction === "left"
              ? h.next()
              : b.direction === "right" && h.prev();
        },
        N = function () {
          this.focus();
        };
            ...
            e.each(p, function (h, _) {
              ...
              T ||
                ...
                a
                  ...
                  : T.el.on("click" + s, f(T)).on("click" + s, function (I) {
                      I.preventDefault();
                    });
            });
          },
    ...
    gt.define(
      ...
      (Vv.exports = function (e, t) {
        ...
        function U(E) {
          return function (X) {
            switch (X.keyCode) {
              case we.SPACE:
              case we.ENTER:
                return M(E)(), X.preventDefault(), X.stopPropagation();
              case we.ESCAPE:
                return se(E), X.preventDefault(), X.stopPropagation();
              case we.ARROW_RIGHT:
              case we.ARROW_DOWN:
              case we.HOME:
              case we.END:
        ...
        function b(E, X) {
          ...
          if ((K.open && !B && !c && se(K, !0), K.container.length)) {
            var fe = ee(K);
        ...
        function ee(E) {
          ...
          return (
            X === "none" && (X = ""),
            function (K, B) {
              (B = e(B)), B.css(k, ""), B.css(k) === "none" && B.css(k, X);
            }
          );
        }
        function ne(E, X) {
        ...
        function J(E, X) {
          ...
          if (
            (E.overlay &&
              ((P = E.menu.prev()), E.overlay.show().append(E.menu)),
            K.animOver)
          ) {
            n(E.menu)
              .add(A)
              .set({ x: K.animDirect * Ce, height: fe })
              .start({ x: 0 })
              .then(w),
          ...
          var O = l + Xe;
          n(E.menu).add(A).set({ y: -O }).start({ y: 0 }).then(w);
          function w() {
        ...
        function ye(E) {
          ...
          return (
            X.animOver
              ? E.menu.height(K)
              : E.el.css("position") !== "fixed" && (K -= E.el.outerHeight(!0)),
        ...
        function se(E, X) {
          ...
          if (K.animOver) {
            n(E.menu)
              .add(B)
              .start({ x: Xe * K.animDirect })
              .then(y);
            return;
          }
          var l = Ce + fe;
          n(E.menu).add(B).start({ y: -l }).then(y);
          function y() {
            E.menu.height(""),
              ...
              E.overlay &&
                ...
                (P.length ? E.menu.insertAfter(P) : E.menu.prependTo(E.parent),
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-12": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|54cfcadb-e8d1-3fdf-1592-7c88d740b00e",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-14": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|1c29725b-cf9e-a49d-7d7c-ccc70a12802d",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-16": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|3bb9b8e4-b80e-0d2a-22f1-52ccfe3b118d",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-18": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|ede77518-7561-2248-c811-452853b87491",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-20": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|d9bdf272-db6d-e0cc-f5ce-12a3addc546c",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-22": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|4c9c4307-106c-be6d-738d-d09730864a25",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-24": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|2fd1adc7-a016-60a8-e041-af5290c334ea",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-40": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|93d70ad6-7625-200b-5dfd-bd850990f3fd",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-42": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|44c6d9db-29c3-2396-72c1-32492179481b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-46": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|4b914be7-8f9c-d8a1-d12c-9672f1ebf313",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-48": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|4fbcff52-53ec-c681-6c72-16023f59cb28",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-50": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|be005dbd-a7e9-0a25-7511-6cc26b3985cb",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-52": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|e304e7a6-8278-db59-7b91-6f2a88c134da",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-54": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|e24521b3-dd2e-36c7-294f-c709844f83f2",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-56": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|4935aa35-662b-aad1-2151-5fc0eb8e4168",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-71": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|8c853ba8-f592-9c30-b04e-f8c9842dbbcb",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-73": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|e3326f3f-b5da-0492-248b-7de28e12f9e2",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-75": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|61ef7aee-9814-4aae-d1b8-c3d2abc51541",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-83": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|1da346bf-b188-94ed-13eb-c73cb482c9f0",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-85": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|b03bfdb8-1c8b-3eda-aa56-436518f227ba",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-96": {
      ...
      target: {
        selector: ".hero-card",
        originalId:
          "66db7f57ef9c0c7a7026f68d|0c684335-918c-f765-979f-8bced67f7913",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-124": {
      ...
      target: {
        id: "66db7f57ef9c0c7a7026f68d|b01bca43-8538-1939-ee50-6086d5eaf403",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-125": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".about-the-game-image-holder",
        originalId:
          "66db7f57ef9c0c7a7026f68d|321bc860-6d3c-e0fc-fdde-06518ce9e7ea",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-127": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "66db7f57ef9c0c7a7026f68d|e8a9de6f-ac04-8077-f20d-b54fe4f6f7b0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-128": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66db7f57ef9c0c7a7026f68d|036f01ec-fe0b-d545-1e65-901524e8bed9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-129": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66db7f57ef9c0c7a7026f68d|18a114ec-f908-1c8e-6871-39552e86932d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-131": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66db7f57ef9c0c7a7026f68d|205bde85-6c54-c226-7d91-20247c13c6e3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-132": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|cace09f3-df89-1d2d-692d-36df43875bb4",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-133": {
      ...
      mediaQueries: ["main", "medium", "small"],
      target: {
        id: "66db7f57ef9c0c7a7026f68d|85de2652-e48f-13b3-72b6-53f3dc640636",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-134": {
      ...
      target: {
        ...
        originalId:
          "66db7f57ef9c0c7a7026f68d|dfe56fe6-94d6-e478-f8f9-ded3c5f81d12",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-136": {
      ...
      target: {
        selector: ".blog-item",
        originalId:
          "66db7f57ef9c0c7a7026f68d|390b9dbb-1c0c-0bb1-5269-96a58120657f",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-138": {
      ...
      target: {
        selector: ".cta-hero",
        originalId:
          "66db7f57ef9c0c7a7026f68d|89c60de7-0d38-5ab7-d643-fed2ccc94305",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-140": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".maps-character-holder",
        originalId:
          "66db7f57ef9c0c7a7026f68d|86db3b6a-3522-7dd8-ac54-2d9ef606344a",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-142": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".hero-illustation",
        originalId:
          "66db7f57ef9c0c7a7026f68d|9d67b67f-13a8-f833-83d8-10a23507b6c8",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-146": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66db7f57ef9c0c7a7026f691|a80bfb48-3abe-1b20-6b83-26ad05ad0fa5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
    ...
    "a-38": {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: ".main-background-image",
                      selectorGuids: ["29e1600d-ce70-eb1b-508f-4d6d845400a0"],
                    },
                    xValue: 1.1,
                    yValue: 1.1,
                    locked: true,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".hero-text",
                      selectorGuids: ["b1fade28-077b-1acb-9084-cfcb6abf330f"],
                    },
                    yValue: 75,
                    xUnit: "PX",
                    yUnit: "%",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".main-character-image",
                      selectorGuids: ["a478619e-2ec8-7dab-3442-f0502f4b04e3"],
                    },
                    yValue: -9,
                    xUnit: "PX",
                    yUnit: "%",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".main-text-container",
                      selectorGuids: ["e5b0c870-8c90-2a2f-83b0-65e883715d33"],
                    },
                    xUnit: "PX",
                    yUnit: "PX",
                    zUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["eeb9ee8c-3514-df9b-c4c1-11f64217ff8e"],
                    },
                    value: 0.63,
                    unit: "",
                  },
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".main-text-holder",
                      selectorGuids: ["20e79ef3-395f-f446-b5ae-9378d91ce22a"],
                    },
                    yValue: -50,
                    xUnit: "PX",
                    yUnit: "%",
      ...
      createdOn: 1687204312573,
    },
    "a-39": {
      id: "a-39",
      title: "Image White Overlay Animation",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".white-cover-image._02",
                  selectorGuids: [
                    "8a5bc9dd-036b-fcf9-c6b8-cb2160ddc626",
                    "53298b00-2f8b-eade-2be6-c5a911e47ff1",
                  ],
                },
                yValue: -100,
                xUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".white-cover-image._01",
                  selectorGuids: [
                    "8a5bc9dd-036b-fcf9-c6b8-cb2160ddc626",
                    "01f3107d-36c1-25e3-4036-ba00b56b136a",
                  ],
                },
                heightValue: 100,
                widthUnit: "PX",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1687213929242,
    },
    "a-40": {
      id: "a-40",
      title: "About The Game Paralax",
      continuousParameterGroups: [
        {
          id: "a-40-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".about-the-game-wrapper",
                      selectorGuids: ["9e663557-851c-002b-2845-013c8140a2ba"],
                    },
                    yValue: -44,
                    xUnit: "PX",
                    yUnit: "px",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".about-the-game-image-holder._01",
                      selectorGuids: [
                        "992a0287-e8c3-35b2-e6aa-e5c5a8b1fbcd",
                        "470653de-09d6-a832-0ef6-f9acdcd4b567",
                      ],
                    },
                    yValue: 36,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".about-the-game-image-holder._02",
                      selectorGuids: [
                        "992a0287-e8c3-35b2-e6aa-e5c5a8b1fbcd",
                        "e5d3457b-98c0-e7c8-a356-c2361be6484c",
                      ],
                    },
                    yValue: -44,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".about-the-game-image-holder._03",
                      selectorGuids: [
                        "992a0287-e8c3-35b2-e6aa-e5c5a8b1fbcd",
                        "aeccf901-55fb-a586-6379-2f9272e10dbc",
                      ],
                    },
                    yValue: -92,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".about-the-game-image-holder._04",
                      selectorGuids: [
                        "992a0287-e8c3-35b2-e6aa-e5c5a8b1fbcd",
                        "e5611fde-2d1c-a5ef-4316-91874f4fa243",
                      ],
                    },
                    yValue: 60,
                    xUnit: "PX",
      ...
      createdOn: 1687214322261,
    },
    "a-41": {
      id: "a-41",
      title: "Heros Paralax Animation",
      continuousParameterGroups: [
        {
          id: "a-41-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".hero-illustation-container._01",
                      selectorGuids: [
                        "2ac49a21-e0e5-181f-7b53-b55af69293d3",
                        "b724265f-5f5f-ef39-8f0e-516bb745229c",
                      ],
                    },
                    yValue: -25,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".hero-illustation-container._02",
                      selectorGuids: [
                        "2ac49a21-e0e5-181f-7b53-b55af69293d3",
                        "7815f925-d14d-5f8c-fcb7-9c81d01222a5",
                      ],
                    },
                    yValue: 4,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".hero-illustation-container._03",
                      selectorGuids: [
                        "2ac49a21-e0e5-181f-7b53-b55af69293d3",
                        "4cd027c3-3cb6-a456-d5dc-a88f5fd541ed",
                      ],
                    },
                    yValue: 20,
                    xUnit: "PX",
      ...
      createdOn: 1687214615238,
    },
    "a-42": {
      id: "a-42",
      title: "Maps While Scrolling Animation",
      continuousParameterGroups: [
        {
          id: "a-42-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".chacater-image",
                      selectorGuids: ["2934ebc0-520f-7364-346f-a7a60287ec6c"],
                    },
                    yValue: -180,
                    xUnit: "PX",
                    yUnit: "px",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["53c92356-fbb9-5e10-a3c6-747f20d312a9"],
                    },
                    xValue: 20,
                    yValue: -52,
                    xUnit: "px",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".map-video-holder",
                      selectorGuids: ["95c98355-622b-8c27-63b8-12db60311ab6"],
                    },
                    yValue: -76,
                    xUnit: "PX",
                    yUnit: "px",
      ...
      createdOn: 1687215002289,
    },
    "a-43": {
      id: "a-43",
      title: "Items Animation While Scrolling",
      continuousParameterGroups: [
        {
          id: "a-43-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".game-items",
                      selectorGuids: ["d4452935-108a-a5fd-bf7d-404a7d361fa2"],
                    },
                    xValue: -10,
                    xUnit: "%",
                    yUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".items-heading",
                      selectorGuids: ["ddc42b14-4a5d-44d2-d15f-0de4d1733ccc"],
                    },
                    xValue: 5,
                    xUnit: "%",
                    yUnit: "PX",
      ...
      createdOn: 1687215123720,
    },
    "a-44": {
      id: "a-44",
      title: "CTA Section While Scrolling Animation",
      continuousParameterGroups: [
        {
          id: "a-44-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".cta-holder",
                      selectorGuids: ["d5ac2003-78db-09e4-c0c1-d7af798eabf5"],
                    },
                    yValue: -60,
                    xUnit: "PX",
                    yUnit: "px",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".cta-hero",
                      selectorGuids: ["008cb6ca-8a2b-45d2-9b3a-7f0e2fe47764"],
                    },
                    yValue: 76,
                    xUnit: "PX",
                    yUnit: "px",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["3133b0a4-75df-98d5-819a-c7c59abdcf5b"],
                    },
                    yValue: -52,
                    xUnit: "PX",
                    yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".red-box",
                  selectorGuids: ["4083463f-2dd1-0860-d8ea-1edb198a3dd3"],
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".blog-item-wrapper",
                  selectorGuids: ["10dbd484-a730-df5b-511a-f6556c98d9ac"],
                },
                xValue: 1,
                yValue: 1,
                locked: true,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: ".loader-holder",
                  selectorGuids: ["45ecf6b3-4179-8c60-0616-4bf9e1e0e53a"],
                },
                value: "flex",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".main-character-container",
                  selectorGuids: ["5e8209d2-c778-d460-8747-a2e719818490"],
                },
                xValue: 0.95,
                yValue: 0.95,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".main-background-holder",
                  selectorGuids: ["44d3fcf6-f819-7ce7-8cc9-421520ac354b"],
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                globalSwatchId: "--secondary-bg-color",
                rValue: 43,
                bValue: 43,
                gValue: 43,
                aValue: 1,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["3757d677-0f68-832a-0044-68001206a42b"],
                },
                yValue: 60,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f2c696ad-4842-23b4-c8c3-3aa1eb2b2c8b"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: ".loading",
                  selectorGuids: ["dd6b3694-3a4f-8097-04a6-473b3dd969b1"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                fontVariations: [
                  { type: "wght", id: "4343", value: 100 },
                  { type: "wdth", id: "7c0f", value: 62 },
                ],
                target: {
                  selector: ".loading-text",
                  selectorGuids: ["be526c30-af8b-01cc-35c5-6b97dab25aa4"],
                },
              },
            },
          ],
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                duration: 2300,
                fontVariations: [
                  { type: "wght", id: "4343", value: 900 },
                  { type: "wdth", id: "7c0f", value: 125 },
                ],
                target: {
                  selector: ".loading-text",
                  selectorGuids: ["be526c30-af8b-01cc-35c5-6b97dab25aa4"],
            ...
            },
            {
              ...
              config: {
                ...
                filters: [
                  { type: "grayscale", filterId: "7558", value: 0, unit: "%" },
                ],
              },
            },
          ],
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-links._01",
                  selectorGuids: [
                    "01831e4a-dc8f-0ac0-f938-0f074fb646d9",
                    "7b33d226-216d-6b4f-5e10-7a06f7546bf4",
                  ],
                },
                xValue: -103,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-links._02",
                  selectorGuids: [
                    "01831e4a-dc8f-0ac0-f938-0f074fb646d9",
                    "154b5de1-66ce-aa44-8e47-091dd06d5d0a",
                  ],
                },
                xValue: -103,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-links._03",
                  selectorGuids: [
                    "01831e4a-dc8f-0ac0-f938-0f074fb646d9",
                    "b93fe7f2-886e-e10b-24b6-04d3e8f79f9f",
                  ],
                },
                xValue: -103,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-links._04",
                  selectorGuids: [
                    "01831e4a-dc8f-0ac0-f938-0f074fb646d9",
                    "fa4c1992-c30e-1016-b82d-47035d237598",
                  ],
                },
                xValue: -103,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-links._05",
                  selectorGuids: [
                    "01831e4a-dc8f-0ac0-f938-0f074fb646d9",
                    "a415face-b787-a2cd-22d1-aef814525821",
                  ],
                },
                xValue: -103,
                xUnit: "%",
    ...
    "a-49": {
      id: "a-49",
      title: "Hero Section Animation Mobile",
      continuousParameterGroups: [
        {
          id: "a-49-p",
          type: "SCROLL_PROGRESS",
